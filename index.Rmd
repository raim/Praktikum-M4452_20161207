...
```{r, fig.width=12, fig.height=5}
viewGroups(data, groups=groups, groups2=groups2, dids="mV/OD", xid="OD", lwd.orig=1, ylim=c(0,1e4), g2.legend=FALSE)
```
...
viewGroups(data, groups=groups[2], groups2=groups2, ylims=list("mV/OD"=c(0,1e4)),embed=TRUE,no.par=TRUE,g2.legend=FALSE)
